...
const techStack = [
  {
    category: "Backend",
    items: ["Node.js", "NestJS", "TypeScript"],
  },
  {
    category: "Database",
  ...
  {
    category: "DevOps",
    items: ["Docker", "Docker Compose", "REST APIs"],
  },
  {
    category: "Tools",
...
const socials = [
  {
    ...
    bg: "#f4656b",
    link: "https://github.com/OthmaneEr-Refaly",
  },
  {
    id: 2,
    text: "Platform",
  ...
  },
  {
    ...
    bg: "#05b6f6",
    link: "https://www.linkedin.com/in/othmaneerrefaly/",
  },
];
...
const WORK_LOCATION = {
  ...
  children: [
    ...
    {
      id: 5,
      name: "MyCel Freelancer CRM Website",
    ...
    {
      id: 6,
      name: "ai architecture visualization app",
      icon: "/images/folder.png",
      kind: "folder",
      position: "top-52 right-80",
      ...
      children: [
        {
          id: 1,
          name: "ai architecture visualization app.txt",
          icon: "/images/txt.png",
          kind: "file",
          fileType: "txt",
        ...
        {
          id: 2,
          name: "ai-architecture-visualization-app.com",
          icon: "/images/safari.png",
          kind: "file",
          fileType: "url",
        ...
        {
          id: 4,
          name: "ai-architecture-visualization-app.png",
          icon: "/images/image.png",
          kind: "file",
          fileType: "img",
    ...
    // ▶ Project 3
    {
      ...
      children: [
        {
          id: 1,
          name: "Backend Diagrams Project.txt",
          icon: "/images/txt.png",
          kind: "file",
          fileType: "txt",
          position: "top-5 left-10",
